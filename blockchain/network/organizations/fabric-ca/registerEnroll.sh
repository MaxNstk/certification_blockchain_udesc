...
function createUdesc() {
  ...
  for PEER in "${UDESC_PEERS_NAMES[@]}"; do
    ...
    set -x
    fabric-ca-client enroll -u https://${PEER_NAME}:${PEER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
    { set +x; } 2>/dev/null 
    ...
    set -x
    fabric-ca-client enroll -u https://${PEER_NAME}:${PEER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls" --enrollment.profile tls --csr.hosts ${PEER_NAME}.udesc.local.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
    { set +x; } 2>/dev/null 
    ...
    set -x
    fabric-ca-client enroll -u https://${USER_NAME}:${USER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M "${PWD}/organizations/peerOrganizations/udesc.local.com/users/${USER_NAME}@udesc.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
    { set +x; } 2>/dev/null      
