...
function createUdesc() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:${UDESC_CA_PORT} --caname ca-udesc --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo "NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-${UDESC_CA_PORT}-ca-udesc.pem
  ...
  fabric-ca-client enroll -u https://udescadmin:udescadminpw@localhost:${UDESC_CA_PORT} --caname ca-udesc -M "${PWD}/organizations/peerOrganizations/udesc.local.com/users/Admin@udesc.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
  ...
  for PEER in "${UDESC_PEERS_NAMES[@]}"; do
    ...
    set -x
    fabric-ca-client register --caname ca-udesc --id.name ${PEER_NAME} --id.secret ${PEER_PASSWORD} --id.type peer --tls.certfiles \
        "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
    
    infoln "Registering cliSent user for peer$PEER"
    set -x
    ...
    set -x
    fabric-ca-client enroll -u https://${PEER_NAME}:${PEER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M \
      "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
    ...
    set -x
    fabric-ca-client enroll -u https://${PEER_NAME}:${PEER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M \
     "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls" --enrollment.profile \
      tls --csr.hosts ${PEER_NAME}.udesc.local.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"

    cp "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/tlscacerts/"* \
      "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/ca.crt"
    cp "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/signcerts/"* \
      "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/server.crt"
    cp "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/keystore/"* \
      "${PWD}/organizations/peerOrganizations/udesc.local.com/peers/${PEER_NAME}.udesc.local.com/tls/server.key"

    infoln "Generating the user msp"
    set -x
    fabric-ca-client enroll -u https://${USER_NAME}:${USER_PASSWORD}@localhost:${UDESC_CA_PORT} --caname ca-udesc -M \
      "${PWD}/organizations/peerOrganizations/udesc.local.com/users/${USER_NAME}@udesc.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/udesc/ca-cert.pem"
...
function createPublic() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:${PUBLIC_CA_PORT} --caname ca-public --tls.certfiles "${PWD}/organizations/fabric-ca/public/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo "NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-${PUBLIC_CA_PORT}-ca-public.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-${PUBLIC_CA_PORT}-ca-public.pem
    OrganizationalUnitIdentifier: peer
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${PUBLIC_CA_PORT} --caname ca-public -M "${PWD}/organizations/peerOrganizations/public.local.com/peers/peer0.public.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/public/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:${PUBLIC_CA_PORT} --caname ca-public -M "${PWD}/organizations/peerOrganizations/public.local.com/peers/peer0.public.local.com/tls" --enrollment.profile tls --csr.hosts peer0.public.local.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/public/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:${PUBLIC_CA_PORT} --caname ca-public -M "${PWD}/organizations/peerOrganizations/public.local.com/users/User1@public.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/public/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://publicadmin:publicadminpw@localhost:${PUBLIC_CA_PORT} --caname ca-public -M "${PWD}/organizations/peerOrganizations/public.local.com/users/Admin@public.local.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/public/ca-cert.pem"
  { set +x; } 2>/dev/null
